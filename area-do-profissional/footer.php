...
?>
  ...
  <!-- SCRIPTS -->
  <!-- JQuery -->
  <script src="<?= Config::BASE_URL_INSTRUCTOR ?>/_theme/js/jquery-3.4.1.min.js"></script>
  <!-- Bootstrap tooltips -->
  <script type="text/javascript" src="<?= Config::BASE_URL_INSTRUCTOR ?>/_theme/js/popper.min.js"></script>
  <!-- Bootstrap core JavaScript -->
  <script type="text/javascript" src="<?= Config::BASE_URL_INSTRUCTOR ?>/_theme/js/bootstrap.js"></script>
  <!-- Dropzone -->
  <script type="text/javascript" src="<?= Config::BASE_URL_INSTRUCTOR ?>/_theme/js/addons/dropzone.js"></script>
  <!-- MDB core JavaScript -->
  <script type="text/javascript" src="<?= Config::BASE_URL_INSTRUCTOR ?>/_theme/js/mdb.min.js"></script>
  <!-- MDBootstrap Datatables  -->
  <script type="text/javascript" src="<?= Config::BASE_URL_INSTRUCTOR ?>/_theme/js/addons/datatables.min.js"></script>
  <!-- Masks -->
  <script type="text/javascript" src="<?= Config::BASE_URL_INSTRUCTOR ?>/_theme/js/jquery.mask.js"></script>
  <!-- Moment -->
...
// MDB Lightbox Init
$(function () {
  $("#mdb-lightbox-ui").load("<?= Config::BASE_URL_INSTRUCTOR ?>/_theme/mdb-addons/mdb-lightbox-ui.html");
});
