    ...
    <div class="row footer-content">
        ...
        <div class="flexbox">
          <div class="flexdiv">
            <div class="footer-text1">
              ...
              <p>CEP: 00000-000</p>
              <a href="https://maps.google.com/?q=Rua Vilela, 652 - Tatuapé, São Paulo - SP" target="_blank">Ver no
                Google Maps</a>
            </div>
            ...
            <div class="footer-text2">
              ...
              <p><i class="fa fa-whatsapp" aria-hidden="true"></i>&nbsp;&nbsp; <a target="_blank"
      ...
      <div class="col-12 d-sm-block d-md-none text-center">
        ...
        <div class="my-2">
          ...
          <p>Bairro, Cidade - Estado</p>
          <p>CEP: 00000-000</p>
          <a href="https://maps.google.com/?q=Rua Vilela, 652 - Tatuapé, São Paulo - SP" target="_blank">Ver no Google
            Maps</a>
        </div>
        <div class="mb-2">
          <p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp; contato@seusite.com.br</p>
