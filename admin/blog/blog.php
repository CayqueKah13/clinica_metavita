...
$info = BlogController::getList($page, $search, $status);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Cadastrar Conteúdo</h4>
  ...
  <div class="col-lg-3 mx-auto mb-4">
    <div class="card-body pt-0">
      ...
      <div class="mt-5">
        ...
        <form action="blog" method="get" class="md-form">
