...
$info = AdminController::getList($page, $search, $status);
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header text-center">
        <h4 class="modal-title w-100 font-weight-bold">Cadastrar Administrador</h4>
  ...
  <div class="col-lg-3 mx-auto mb-4">
    <div class="card-body pt-0">
      ...
      <div class="mt-5">
        ...
        <form action="administradores" method="get" class="md-form">
          ...
          <table class="table table-hover">
            ...
            <tbody>
              <?php foreach ($info['items'] as $key => $value): ?>
                <tr>
                  <td>
                    <?= AdminTheme::avatarThumb($value['img'], $value['name']) ?> <?= $value['name'] ?>
                  </td>
                  <td><?= $value['email'] ?></td>
                  <td>
                    <div class="switch default-switch">
                      <label>
                        ...
                        <?php if ($value['id'] == 1) { echo "disabled"; } ?> >
