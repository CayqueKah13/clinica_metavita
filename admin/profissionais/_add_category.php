...
$category = Helper::safeInt($_POST['category']);
...
$status = InstructorController::addCategory($id, $category, $price);


// Tracker::trackAdminEvent(Tracker::TRACK_ADMIN_EDIT_ADMIN, $id);

Session::setSuccessMessage("Categoria adicionada com sucesso!");
Helper::redirectToPage($link);
exit;
