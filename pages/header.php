...
<!-- End Facebook Pixel Code -->
	...
	<link href="<?= $themePath ?>/css/style3.css" rel="stylesheet">
...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-light">
		<div class="container">
			<a class="navbar-brand" href="<?= Config::BASE_URL ?>"><img class="nav-img-logo pix-margin-bottom-20 pix-padding-bottom-20" src="<?= $themePath ?>/assets/logo.png" alt=""></a>
			...
			<div class="collapse navbar-collapse text-right" id="navbarNav">
				...
				<ul class="nav navbar-nav">
					<li class="nav-item <?php if ($currentTab == "home") { echo("active"); } ?>">
						<a class="nav-link" href="<?= Config::BASE_URL ?>">Home</a>
					</li>
					<li class="nav-item <?php if ($currentTab == "about") { echo("active"); } ?>">
						<a class="nav-link" href="<?= Config::BASE_URL ?>/sobre">Sobre Nós</a>
					</li>
					<li class="nav-item <?php if ($currentTab == "blog") { echo("active"); } ?>">
	...
	<a class="nav-link dropdown-toggle" href="servicos.html" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Especialidades</a>
	<div class="dropdown-menu" aria-labelledby="navbarDropdown">
		<!--<a class="dropdown-item" href="<?= Config::BASE_URL ?>/corredores">Corredores</a>-->
		<a class="dropdown-item" href="<?= Config::BASE_URL ?>/lutas">Lutas</a>
		...
		<a class="dropdown-item" href="<?= Config::BASE_URL ?>/esportes">Esportes</a>
