    ...
    <div class="row footer-content copyright a">
        ...
        <div class="flexbox">
          <div class="flexdiv">
            <div class="footer-text1 pix-white">
              ...
              <p>CEP: 00000-000</p>
              <a href="https://maps.google.com/?q=Rua Endereço vai aqui" target="_blank"
                class="pix-white">Ver no Google Maps</a>
            </div>
            ...
            <div class="footer-text2 pix-white">
              ...
              <p><i class="fa fa-whatsapp" aria-hidden="true"></i>&nbsp;&nbsp; <a class="pix-white" target="_blank"
                  href="<?= Config::WHATSAPP_URL ?><?= Helper::numbersOnly(Config::WHATSAPP_NUMBER); ?>&text=<?= urlencode(Config::WHATSAPP_MESSAGE) ?>"><?= Config::WHATSAPP_NUMBER ?></a></p>
            </div>
          </div>
        </div>
      </div>
      <div class="col-12 d-sm-block d-md-none text-center">
        ...
        <div class="my-2">
          ...
          <p>Bairro, Cidade - Estado</p>
          <p>CEP: 00000-000</p>
          <a class="pix-white" href="https://maps.google.com/?q=Rua Endereço vai aqui"
            target="_blank"><strong>Ver no Google Maps</strong></a>
        </div>
        <div class="mb-2">
          <p><i class="fa fa-envelope" aria-hidden="true"></i>&nbsp;&nbsp; contato@seusite.com.br</p>
